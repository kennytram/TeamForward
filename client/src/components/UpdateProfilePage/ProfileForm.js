  ...
  return (
    <section className="">
      <div className="max-w-2xl py-8 px-4 mx-auto">
        {formUnfinishedNotification(formInfo, profileImg) ? null : (
          <div
            style={{ marginTop: "-25px" }}
            className="rounded-lg bg-primary-100 p-2 text-center text-neutral-700 shadow-lg mb-2"
          >
            <p>
              Let's finish your profile, connect to people you know, and engage
              with them through shared interests.
            </p>
          </div>
        )}
        <h2 className="mb-4 text-xl font-bold text-gray-900">Update Profile</h2>
        <UploadProfileImg
          ...
          <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
            ...
            <div className="w-full">
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormInfoChange("country", e.target.value)
                }
                placeholder=""
                required=""
              />
