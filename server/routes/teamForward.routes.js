...
module.exports = (app) => {
  ...
  app.patch("/teamForward/:id", authenticate, UserController.updateUser);
  app.patch("/teamForward/:id/gallery/upload", authenticate, UserController.uploadGallery);
  app.patch("/teamForward/:id/gallery/update/:photoId", authenticate, UserController.updateGallery);
  app.patch("/teamForward/:id/gallery/delete/:photoId", authenticate, UserController.deleteGallery);
